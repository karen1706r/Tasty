...
export const ROUTES: RouteInfo[] = [
    {
        ...
        submenu: [
           // { path: '/dashboard/Predicciones', title: 'Graficas', icon: 'bx bx-right-arrow-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    ...
    },
    {
        ...
        submenu: [
            {
                path: '/dashboard/show-preparaciones',
                title: 'Preparaciones',
